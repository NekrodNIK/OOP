...
public class DerivativeTest {
  ...
  @Test
  void testMul() {
    assertEquals(new Add(new Mul(new Number(1), new Variable("y")), new Mul(new Variable("x"), new Number(0))),
  ...
  void testDiv() {
    assertEquals(
        new Div(new Sub(new Mul(new Number(1), new Variable("y")), new Mul(new Variable("x"), new Number(0))),
